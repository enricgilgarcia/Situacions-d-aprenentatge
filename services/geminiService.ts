...
1. Competències Específiques: Han de coincidir amb les del DECRET oficial. Seguir el format "CE.X. [Descripció]" (ex: CE.1. Identificar els elements...). Inclou l'àrea o matèria.
2. Criteris d'Avaluació: Han de coincidir amb la nomenclatura del decret (ex: 1.1, 1.2, 2.1...).
...
6. Vectors i Suports: Descriure com s'aborden els vectors del currículum i les mesures DUA.

IMPORTANT: Fidelitat absoluta als termes i competències del decret oficial de Catalunya. No inventis nomenclatures.`;
